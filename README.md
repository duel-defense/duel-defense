...
Mods can be manually installed and mod.io is integrated with the game, so that mods can be downloaded in-game. See https://mod.io/g/duel-defense1 for a list of mods, and to upload a mod.
